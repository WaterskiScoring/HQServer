...
'
'		Use:
'			Set objField = objUpload.Fields("UserFile")
'			Set objField = objUpload("UserFile")
'			Set objField = objUpload.Fields(0)
'			Set objField = objUpload(0)
'			Response.Write objUpload("UserFile").Name
...
'
'<FORM method="post" encType="multipart/form-data" action="/rankings/Upload.asp">
...
' ------------------------------------------------------------------------------
	Private Sub ParseChunk(ByRef pbinChunk)
		...
		'	Content-Disposition: form-data: name="UserFile"; filename="C:\Photo.gif"
...
' ------------------------------------------------------------------------------
	Private Function ParseDisposition(ByRef pbinChunk)
		...
		'
		'	Would Return:
		'		form-data: name="UserFile"; filename="C:\Photo.gif"
