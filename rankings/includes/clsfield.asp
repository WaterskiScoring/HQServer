...
'
'		ie: C:\Documents and Settings\Desktop\Photo.gif
'
'	objField.FileDir
'		Directory that file was sent from
'
'		ie: C:\Documents and Settings\Desktop
'
'	objField.FileExt
...
'
'		use: objField.SaveAs(Server.MapPath("/rankings/Uploads/") & "\" & objField.FileName)
'
' ------------------------------------------------------------------------------
Class clsField
	...
	Private mstrPath		' Full path to file on visitors computer
							' C:\Documents and Settings\Desktop\Photo.gif
