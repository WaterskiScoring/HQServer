...
'Count the number of states
	...
	if left(Session("UserName"),1) > "9" THEN
		...
		if len(request.form("TournamentID")) > 0 then
			...
			TopUser.Open "SELECT UT.*, ST.TDateE, ST.TSanction FROM Users999 as UT, Sanctions.dbo.Tschedul as ST WHERE ST.TournAppID=left(UT.Name,6) and lower(UT.Name) = '" & left(epl_removeinvalidchars(Request.Form("TournamentID")),6) & "'"
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <form action="CreatePreRegTemplateSetup-New.asp" method="post">
