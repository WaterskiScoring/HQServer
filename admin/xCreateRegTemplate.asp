...
objFSO.CopyFile path & "/Templates/template_blank_with_scores.xls", path & "/template.xls" , True
...
<table border="0" cellspacing="0" cellpadding="0">  
  ...
  <table>
      <tr> 
         <td width="14">&nbsp;</td>
         <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>Your Registration 
         Template is now complete and ready to download.</font></td>
      </tr>
