...
ELSE
  ...
  ' Set up search criteria in Member Table for members matching criteria
	...
	sSQL = "SELECT TOP 11 Mem.PersonIDWithCheckDigit AS MemberID, Mem.LastName, Mem.FirstName, Mem.CompanyName,"
				...
				%><tr>
       			  <TD ALIGN="Center" vAlign="top" BGCOLOR="#FFFFFF"><FONT COlOR="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("memberid")%></FONT></TD>
	           		...
	           		<TD ALIGN="Center" vAlign="top" BGCOLOR="#FFFFFF"><FONT COlOR="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="ValidateMember.asp?MemberID=<%=rs("memberid")%>"><%=rs("LastName")%>,&nbsp;<%=rs("FirstName")%></a></FONT></TD>
							<% ELSE %>
	           		<TD ALIGN="Center" vAlign="top" BGCOLOR="#FFFFFF"><FONT COlOR="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="ValidateClub.asp?MemberID=<%=rs("memberid")%>"><%=rs("CompanyName")%></a></FONT></TD>
							<% END IF %>
