...
sSQL = sSQL & " AND (" & Session("StateSQL") & " OR PersonID"
sSQL = sSQL & " IN (Select distinct cast(right(MemberID,8) as integer)"
sSQL = sSQL & " from Cobra00025.USAWSRank.RegisterGen_05042014" 
sSQL = sSQL & " Where left(TourID,6) = '" & left(Session("TournamentID"),6)
...
sSQL3 = sSQL3 & "') as PR on RD.MemberID = PR.MemberID"
...
sSQL3 = sSQL3 & "') as PS on RD.MemberID = PS.MemberID"
...
sSQL3 = sSQL3 & " and left(TourID,6) = '" & left(Session("TournamentID"),6)
sSQL3 = sSQL3 & "') as PT on RD.MemberID = PT.MemberID"
...
sSQL3 = sSQL3 & " and left(TourID,6) = '" & left(Session("TournamentID"),6)
sSQL3 = sSQL3 & "') as PJ on RD.MemberID = PJ.MemberID"
