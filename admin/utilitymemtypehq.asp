...
' sSQL = "SELECT * FROM [Membership Types with pricing] Where EffectiveFrom >= '2010-01-01'" 
' sSQL = "SELECT * FROM [tblMembershipTypeCodes]" 
sSQL = "SELECT * FROM [MembershipTypeRates] WHERE EffectiveFrom >= '2010-01-01' Order by [Membership Type Code]" 
'	sSQL = "SELECT * FROM [MembershipTypeRates] WHERE EffectiveFrom >= '2010-01-01' Order by MembershipTypeCode" 
