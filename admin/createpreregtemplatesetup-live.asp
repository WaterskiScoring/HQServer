...
'Count the number of states
	...
	if Request.Form("IncludeElite") = "True" then
		if len(Session("StateSQL")) > 0 then Session("StateSQL") = Session("StateSQL") & " OR"
		Session("StateSQL") = Session("StateSQL") & " MT.PersonID in"
		Session("StateSQL") = Session("StateSQL") & " (Select distinct cast(right(MemberID,8) as integer) FROM Cobra00025.usawsrank.Rankings" 
	...
	if ErroronPage = True then
   	...
   	'		Set logobject=tempFSO.OpenTextFile(Server.mappath("/")&"\..\" & "sql-debug-log.txt",8,true)
		...
		if request.form("FileFormat") = "without_scores" then
			...
			response.redirect "CreatePreRegTemplate-Live.asp"
		end if
...
<head>
<title>Pre-Registration Export Controls</title>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <form action="CreatePreRegTemplateSetup-Live.asp" method="post">
...
%>
         ...
         File format version:</font> </td>
			...
			<tr>
         <td>&nbsp;</td>
         <td><input type="submit" name="NowWhat" value="Create Export"
         	title="Click here to create your Export.&#13;This will take a minute or two;&#13;    So please stand by ... "></td>
         <td>&nbsp;</td>
		     <td>
