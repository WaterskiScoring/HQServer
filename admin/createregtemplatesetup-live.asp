...
'Count the number of states
	...
	if Request.Form("IncludeElite") = "True" then
		...
		Session("StateSQL") = Session("StateSQL") & " (Select cast(right(MemberID,8) as integer) FROM Cobra00025.usawsrank.Rankings" 
...
'			response.redirect "CreateRegTemplateNew.asp"
			response.redirect "CreateNonPreRegTemplate-Live.asp"
		end if
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <form action="CreateRegTemplateSetup-Live.asp" method="post">
