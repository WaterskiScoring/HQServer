...
'	RS.open "SELECT * FROM [Export Members to Excel] Where PersonIDWithCheckDigit='" & PersonIDwChkDgt(request("PersonID")) & "';" 

sSQL = "SELECT Mem.PersonID, Mem.LastName, Mem.FirstName, Mem.City," 
...
sSQL = sSQL & " Mem.Address1, Mem.Address2, Mem.Zip, Mem.FederationCode as FedCode," 
sSQL = sSQL & " Mem.ForeignFederationID as ForFedID, Mem.Email,"
...
sSQL = sSQL &+ " AND Mem.PersonID='" & Request("PersonID") & "';" 

RS.open sSQL

	SkiAge = Session("TournamentYear") - DATEPART("yyyy", RS("BirthDate")) - 1

	MemData = left(PersonIDwChkDgt(rs("PersonID")),3) & "-" & mid(PersonIDwChkDgt(rs("PersonID")),4,2) & "-" & right(PersonIDwChkDgt(rs("PersonID")),4)
	...
	ContactDtls = ContactDtls & "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Federation:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " & RS("FedCode") & "&nbsp;&nbsp;&nbsp; Fed ID #: " & RS("ForFedID")
	ContactDtls = ContactDtls & "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Member Type:&nbsp;&nbsp;&nbsp; " & RS("TypeCode") & "&nbsp;&nbsp;&nbsp; SptsDiv: " & RS("SptsDiv")
...
sSQL = sSQL + Right(PersonIDwChkDgt(request("PersonID")),8) & "GROUP BY OD.RatingType_ID"
...
sSQL = sSQL & " and MemberID = '" & PersonIDwChkDgt(request("PersonID")) & "' group by Event)"
sSQL = sSQL & " as ED on Left(RT.Event,1) = ED.Event"
sSQL = sSQL & " WHERE RT.MemberID = '" & PersonIDwChkDgt(request("PersonID"))
