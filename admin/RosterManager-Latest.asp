...
<table border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="180" valign="top" bgcolor="#42639F">
			...
			<% IF Session("id") = 850 or Session("id") = 6433 or Session("id") = 15757 or Session("id") = 121749 or session("id") = 103995 or Session("id") = 9796 or Session("id") = 6921 or Session("id") = 106475 or Session("id") = 123143 or Session("id") = 138926 or Session("id") = 86262 or Session("id") = 116714 or Session("id") = 9498 THEN %>
...
ELSE
  ...
  ' Set up query to pull Team Roster Table for current TeamID
	...
	sSQL = "SELECT Mem.PersonIDWithCheckDigit AS MemberID, Mem.Email," 
...
IF LastPerson <> Session("id") and Session("id") <> 850 THEN
	...
	IF LastPerson > 0 THEN
		...
		IF Instr(PrevEmail,"@") > 0 and instr(CurrEmail,"@") > 0 THEN
			...
			objMessage.BCC = """Dave Clark"" <awsatechdude@comcast.net>"
