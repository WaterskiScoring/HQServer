    ...
    <td valign="top" >
        ...
        <tr>
          ...
          <td valign="top"> 
            ...
            <p>Members may be selected geographically for up to five states, and foreign 
            ...
            registration and scoring set-up of your tournament.</p>
            
            <p>In addition to the geographic/status selection of skiers in a downloaded
            ...
            Template that you have downloaded earlier.</p>

            <p><font color="red"><b>A new feature added for 2010</b></font></p>
            
            <p><b>Chief and Appointed Officials</b>.&nbsp; Chief and Appointed officials
            ...
            the instructions section of your downloaded Excel file.</p>

					<%
					IF left(Session("UserName"),1) > "9" THEN
					%>

						<p><b><i>Note: As an Administrative User</i></b>, I will show you detailed 
						...
						this added contact information.</p>
            ...
            <p>To begin accessing these features, click on either the &quot;Create 
            Registration Template&quot; or &quot;Look Up Individual Members&quot; 
            links, that appears to the left.</p></font><br>
