...
<head>
<title>USA Water Ski Member Number Problems v1.1</title>
  ...
  <tr> 
    <td bgcolor="#42639F">
      ...
      <p align="center"><font face="Verdana" size="6" color="#FFFFFF">
      	USA Water Ski Possible Expires Re-Enrolling</font></p>
      <p>&nbsp;</p>
    </td>
  </tr>
</table>
...
%> <table width="65%" align="Center" Cellpadding="0" Cellspacing="5">
	...
	<tr align="Center"><form action="/admin/FindExpiresReEnrolling.asp" method="post">  
		...
		<td><input type="submit" value="Find Re-Enrollments"></td></form>
	</tr>
