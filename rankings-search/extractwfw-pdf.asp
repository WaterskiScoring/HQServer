...
Dim objFSO, objZip, objRS, objMail, eMailSubj, eMailFrom, eMailTo, eMailCC, SeedRep, Owner
...
ExtractFile strFileName, strTourFldr, 1000
...
IF instr("ELRPAB",mid(Session("strTourID"),7,1)) > 0 THEN
	...
	ExtractFile strFileName, strTourFldr, 6400
...
IF len(eMailTo) > 0 THEN
	...
	ELSE
   	...
   	eMailFrom = """USA Water Ski Competition"" <bhoyland@usawaterski.org>"
		SeedRep = Session("Firstname") & " " & Session("LastName") & " on behalf of Britt Hoyland" & vbCRLF & "Competition & Events Coordinator" & vbCRLF & "bhoyland@usawaterski.org" & vbCRLF & "1-863-324-4341 ext 121"
	END IF

	IF mid(strTourID,3,1) = "U" THEN
   	eMailCC = eMailCC & "; ""Jeff Surdej"" <j_surdej@yahoo.com>; ""Mike Mayleben"" <mike.mayleben@joomgo.com>; ""Cris Kodiak"" <cris.kodiak@gmail.com>; ""Yvonne Downs"" <bellpass@aol.com>"
