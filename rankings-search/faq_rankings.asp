...
%>
<div style="color:red; font-size:16pt; text-align:center;">Rankings FAQ</div>
<a name="TopTop"></a>
<div style="color:#000000; font-size:10pt; text-align:left;">
<ul><b>
<li><a href="<%=ThisFileName%>#WhatsNew"><font color="red"> What's new for 2010 -- Elite Qualification</font></a></li>
<br><li><a href="<%=ThisFileName%>#LevsPcts"> Explanation of Levels and Percentiles</a></li>
...
<TABLE align=left>
  <TR>
    <TD bgcolor="#FFCCCC">&nbsp;Level 9&nbsp;</td>
    <TD>&nbsp;&nbsp;</td>
    <TD bgcolor="#CCFFCC">&nbsp;Level 8&nbsp;</td>
    <TD>&nbsp;&nbsp;</td>
    <TD bgcolor="#FFFF66">&nbsp;Level 7&nbsp;</td>    
    <TD>&nbsp;&nbsp;</td>
    <TD bgcolor="#CCCCFF">&nbsp;Level 6&nbsp;</td>    
    <TD>&nbsp;&nbsp;</td>
    <TD bgcolor="#CC99FF">&nbsp;Level 5&nbsp;</td>    
    <TD>&nbsp;&nbsp;</td>
    <TD bgcolor="#F5DEB3">&nbsp;Level 4&nbsp;</td>    
    <TD>&nbsp;&nbsp;</td>
    <TD bgcolor="#FFFACD">&nbsp;Level 3&nbsp;</td>    
  </TR>
</TABLE>
