...
ThisFileName="MemberQualifications2.asp"
...
'Y=999
'IF sMemberID="500074224" AND Y=999 THEN 
'	response.write("<br>TESTING WITH THIS MEMBER")
'END IF
		...
		ELSEIF rs("QfyByRankByCOD")=false AND DateDiff("d", Date, sTourCOD)<=0 AND TRIM(rs("QfyStatus"))="Qualified" THEN 
			sQfyByRankByCODStatus="--"
			sQfyByRankByCODColor=textcolor2
...
'		END IF	
		...
		' --- NEW 8-2-2008 ---
		IF TRIM(rs("QfyStatus"))="Qualified" THEN
			sCurrentStatusColor=textcolor2
...
'END IF
		...
		CurrentStatusTitle="If the Current Status column indicates 'Qualified', then your qualification is locked in.  Otherwise, if this column indicates 'Pending' your qualification will not lock in until the COD for this tournament. NCQ indicates Not Currently Qualified (see below)."
...
SELECT CASE sHomoType
   CASE "A"
	...
	PlaceBTitle="IF 'OK' then you are qualified based on placement in Previous REGIONAL Championships"
...
<br>
<TABLE align=center width="<%=TourTableWidth%>">
<TR>
...
<TR>
  <td align="left" colspan=2>
	<font size="<%=fontsize2%>" color="<%=TextColor1%>"><b><u>Current Status</u></b> - If the Current Status column indicates 'Qualified', then your qualification is locked in.  Otherwise, if this<br> 
	 column indicates 'Pending' your qualification will not lock in until you have meet the qualifications as of the COD for this<br>
	 tournament, or you have achieved a qualification through another method.</font>
	<br><br>
...
<TABLE class="innertable" align=center width="100%">
<TR>
	<th colspan=4 align="center"><font size="<%=fontsize2%>" color="#FFFFFF">&nbsp;</font></th>
	...
	<th colspan=4 align="center"><font size="<%=fontsize2%>" color="#FFFFFF"><br>Qualification By Placement</font></th>
</TR>
...
<TR>
	...
	<th align="center" width="60px"><font size="<%=fontsize2%>" color="#FFFFFF">League<br>COA</font></th>
