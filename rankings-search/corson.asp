...
If Request("PreviouslySelected") = "ThisOne" and len(trim(request("TourID"))) = 7 THEN
  Session("TourID") = ucase(trim(request("TourID")))
  Response.Redirect("/rankings/IWWF-Export.asp")
End If
