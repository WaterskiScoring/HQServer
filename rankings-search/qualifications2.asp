...
'		response.write("<br><br>sRequirePart="&sRequirePart)
' 	response.write("<br>sQualLevel="&sQualLevel)
'		response.write("<br>sReglPartStat="&sReglPartStat)
'		response.write("<br>TRIM(rs(RegionalOverride))="&TRIM(rs("RegionalOverride")))
'END IF


IF sQualLevel=0 OR sRequirePart="-" THEN
...
ELSEIF sReglPartStat="S" OR sReglPartStat="M" OR sReglPartStat="C" OR sReglPartStat="E" OR sReglPartStat="W" THEN
		RegStatusColor = TextColor2
		RegStatusText = "OK"
...
'IF sMemberID="800106131" THEN
	' -- AND Session("AdminMenuLevel")>=50 THEN 
'		response.write("<br><br>QfyStatus="&rsQFy("QfyStatus"))
'		response.write("<br>subQfyOverride="&subQfyOverride)
'END IF
...
ELSEIF TRIM(subQfyOverride) <> "" THEN
		...
		'QfyStatusTitle(EvtNo)="Administrative Override of Qualifications &#13; Override Code: "&subQfyOverride
		QfyStatusTextNew = "(OV)"
		QfyStatusLongText(1) = "&nbsp; OK - Override: "&subQfyOverride
		QfyStatusTitleNew="Administrative Override of Qualifications &#13; Override Code: "&subQfyOverride
...
ELSEIF NOT rsQfy.eof THEN 
	...
	SELECT CASE TRIM(QfyStatusText(1))
		...
		CASE "NCQ"
			...
			QfyStatusLongText(1) = "&nbsp; Not Qualified: NCQ"
			QfyStatusTitleNew="Not Currently Qualified by any qualification method."
...
'IF sMemberID="800106131" THEN
	' -- AND Session("AdminMenuLevel")>=50 THEN 
'		response.write("<br>QfyStatusText(EvtNo)="&QfyStatusText(EvtNo))
'		response.write("<br>sEvent="&sEvent)
'		response.write("<br>EvtNo="&EvtNo)
'END IF
...
'ELSEIF sSelectEvent(EvtNo)<>"on" THEN
'	QfyStatusColor(EvtNo) = TextColor3
'	QfyStatusText(EvtNo) = "***"
'	QfyStatusLongText(EvtNo) = "&nbsp; Not Entered"
'       QfyStatusTitle(EvtNo)="Not Entered"
