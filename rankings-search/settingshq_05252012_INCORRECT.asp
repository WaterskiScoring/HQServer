...
Dim sEntryEmailMC
sEntryEmailMC=true			' --- Determines whether Mark is copied on 
...
IF TRIM(Request("adminmenulevel")) <> "" AND trim(Request("adminmenulevel")) <> "," THEN
...
' Original Connections prior to testing on 5-18-2012 ---
...
' --- Provided by Arial on 5-17-2012 ---		
	...
	'sConnectionToTRATable = "Provider=SQLOLEDB;SERVER=kingham-sql.epolk.net;uid=U54W5r4NK;Password=4QU4r4nkSAA;Initial Catalog=cobra00025"
	'sConnectionToMemberTable = "Provider=SQLOLEDB;SERVER=kingham-sql.epolk.net;uid=U54W5r4NK;Password=4QU4r4nkSAA;Initial Catalog=USAWaterski"
	'sConnectionToSanctionTable = "Provider=SQLOLEDB;SERVER=kingham-sql.epolk.net;uid=U54W5r4NK;Password=4QU4r4nkSAA;Initial Catalog=Sanctions"





		' --- Not aware these are used ---
    'sConnectionToOLRegFunction = "Provider=SQLOLEDB;SERVER=jaguar.epolk.net;Database=Sanctions;uid="&OLRegUID&";pwd="&OLRegPW
    'sConnectionToSanctionUpdate = "Provider=SQLOLEDB;SERVER=jaguar.epolk.net;Database=Sanctions;uid="&SanUpdUID&";pwd="&SanUpdPW
