...
%>
<div id="rankingslisting" style="max-height:100%; border:0px solid yellow;">
	<a href="javascript:DisplaySearchFilters('searchfilters');" style="text-decoration:none;">
		<div class="searchimagediv" style="margin:0px 0px 0px 0px; background: url(images/buttons/LongButtonBlank.png); background-position:center; background-repeat: no-repeat; text-align:center;">
			<p class="searchbannerline" style="margin:0px 0px 0px 0px;">GO TO SEARCH SETTINGS</p>
		</div>
	</a>

	<div id="rankingscroll" class="scroll">
		<% 
		IF NOT rs.eof THEN 
...
<form method=post action="<%=ThisFileName%>">
  ...
  <input type="hidden" id="sName_InRankingsSettings" name="sMemberID" value="">
