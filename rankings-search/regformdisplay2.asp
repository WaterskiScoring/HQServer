...
'response.write("<br>Line2039 sMemberID="&sMemberID)		
'response.write("<br>Sesssion sMemberID="&Session("sMemberID"))		

'response.write("<br>Line2039 sTourID="&sTourID)
'response.end
...
IO="N"
IF IO="Y" AND sMemberID="000001151" THEN
		response.write("<br>sPayPalActionURL = "&sPayPalActionURL) 
		response.end
END IF	
