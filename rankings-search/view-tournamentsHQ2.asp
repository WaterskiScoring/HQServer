...
ThisFileName="/rankings/View-TournamentsHQ2.asp"
		  	...
		  	<td  width=110px align="Center">
		    	...
		    	<%
					...
					ELSE %>
							...
							<%
							IF OLRButtonEntryStatus<>"disabled" THEN
									%>	
									<input type="image" src="/rankings/images/icons/Create.png" style="width:20px;" title="Enter this Tournament" alt="Enter">
						  		&nbsp;&nbsp;
						  		<%
						  ELSE
									%>	
									<img src="/rankings/images/icons/Delete.png" style="width:20px;" title="Tournament Entry Closed" alt="Closed">
						  		&nbsp;&nbsp;
						  		<%
						  			
						  END IF
						  %>		
						  <a href="/rankings/view-registration.asp?sTourID=<%=sTourID%>" target="_blank">
						  		<img src="/rankings/images/icons/Zoom.png" style="width:18px;" title="Check Registration Status" alt="Check Registration Status">
							</a>
							<input type="hidden" name="sTourID" value="<%=sTourID%>"><%
					END IF 
