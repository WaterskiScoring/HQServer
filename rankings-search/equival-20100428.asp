...
Dim nScoUpdts, nOvrUpdts, nRnkUpdts, nOffUpdts, nNewElites
...
LastHQPID = 0: nScoUpdts = 0: nOvrUpdts = 0: nRnkUpdts = 0: nOffUpdts = 0: nNewElites = 0
...
'	But only for sProcessingYear = 1 -- Last 12 month rankings only.
