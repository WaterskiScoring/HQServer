...
' response.redirect "CompetitionMaintSplashPage.htm": ' transfer to maintenance announcement page.
...
Dim CutOffTableName, RegionTableName, MemberTableName, ConsMemTableName, MemberTypeTableName, MemberTypeOLRTableName, SanctionTableName, GuideBookTableName
...
Dim PathtoTRA2, PathtoNews, PathtoWaivers, PathtoCommune
Dim tempFSO, tempFSO2, tempObjStream, tempObjStream2
Dim logObject
...
RegQualifyTableName = "usawsrank.RegisterQualify"
...
' Changed by Mike Kingham on 3/1/2007
'For local SQL Server Connections
'    sConnectionToTRATable = "Provider=SQLOLEDB;Data Source=(local);User ID=" & HQuser & ";Password=" & HQpass & ";Initial Catalog=00025"
'    sConnectionToMemberTable = "Provider=SQLOLEDB;Data Source=(local);User ID=" & HQuser & ";Password=" & HQpass & ";Initial Catalog=USAWaterski"
'    sConnectionToSanctionTable = "Provider=SQLOLEDB;Data Source=(local);User ID=" & HQuser & ";Password=" & HQpass & ";Initial Catalog=Sanctions"
...
'	Following Application Variable strings picked from HQSQLConn and HQOfficialsConn on 2010-09-15 by DJC
'	"Provider=SQLOLEDB;SERVER=173.221.252.210;Database=waterski;uid=usawaterski;pwd=H2osl@l0m" -- New HQ Server Login
'	"Provider=SQLOLEDB;SERVER=173.221.252.210;Database=officials;uid=officialsweb;pwd=H2osl@l0m99" -- New HQ Officials Login

'For DSN SQL Server Connections
'   SConnectionToTRATable = "DSN=" & TRADSNName & "; UID=" & TRADSNUser & "; PWD=" & TRADSNPass & "; Database=" & TRADBName
'   SConnectionToMemberTable = "DSN=" & HQDSNName & "; UID=" & HQDSNUser & "; PWD=" & HQDSNPass & "; Database=" & MemberDBName
'   SConnectionToSanctionTable = "DSN=" & HQDSNName & "; UID=" & HQDSNUser & "; PWD=" & HQDSNPass & "; Database=" & SanctionDBName
...
SUB OpenConMember
  ...
  ConMember.open(SConnectionToMemberTable)
END SUB
