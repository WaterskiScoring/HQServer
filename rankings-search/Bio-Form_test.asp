	    				...
	    				%>
							...
							<table ALIGN="center" BORDER="1" CELLPADDING="3" CELLSPACING="0" width=100% BGCOLOR="<%=TableColor1%>">   	
								...
								<tr>
									...
									<td colspan=2 align="left"><input type="text" <% =BioStatus %> name="fHobby" value= "<% =sHobby %>" MAXLENGTH=50 size="55"></td>
								...
								<tr>
									...
									<td colspan=2 align="left"><input type="text" <% =BioStatus %> name="fMentors" value= "<% =sMentors %>" MAXLENGTH=60 size="65"></td>
...
<TR>
  <TH align="center">
	<FONT size="3" COlOR="#FFFFFF">Press Continue to Return</strong></FONT>
  </TH>
</TR>  
