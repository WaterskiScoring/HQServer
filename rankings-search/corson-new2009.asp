...
Dim tempLast, tempFirst, tempPlace, tempDiv, tempSL, tempTR, tempJU, tempScore, tempAlt, tempPQ1, tempPQ2, tempSex, tempYOB, tempSpecial, tempExport
Dim RecordsSaved
Dim InsertCmd
Dim PreZBSScore
...
<IMG SRC="/rankings/images/buttons/wait.gif" BORDER=1 WIDTH=75 HEIGHT=15><BR><BR>
  ...
  do while not rs.eof
    ...
    CASE "J"
      ...
      IF (tempSex = "M" and tempScore >= 20) or (tempSex = "F" and tempScore >= 15)  THEN tempExport = "Y": ELSE tempExport = "N"
