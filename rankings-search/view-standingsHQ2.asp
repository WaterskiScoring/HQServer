...
ThisFileName="View-StandingsHQ2.asp"
SearchFileName = "search-memberHQ2.asp"
...
ELSE
	...
	ELSE 		' --- Displays page ---
			...
			IF rs.EOF THEN tRCU = "N" ELSE tRCU = RS("RCUFlag")
					...
					IF tRCU = "Y" AND Session("AdminMenuLevel") = 0 THEN   ' --- Calc underway - Tell them to try again later
...
<% END IF %>
   ...
   <td align="center"><input type=submit style="width:10em" name="SingleRanking" value="Find My Rankings" title="TEMPORARILY OUT OF SERVICE (Look up my Rankings in all Events)" enabled></td><%
		...
		<TR>
  		<TD>  
    		<TABLE class="innertable" ALIGN="Center" WIDTH="90%">
	    		<tr>
    				<th ALIGN="Center" Width=20% vAlign="center" bgCOLOR="<%=HeadCOLOR1%>"><font size=<% =fontsize2 %> COLOR="#FFFFFF"><b>National<br>Rank</b></FONT></th>
    				<th ALIGN="Center" Width=30% vAlign="center" bgCOLOR="<%=HeadCOLOR1%>"><font size=<% =fontsize2 %>  COLOR="#FFFFFF"><b>Division<br>and Event</b></FONT></th> 	
    				<th ALIGN="Center" Width=30% vAlign="center" bgCOLOR="<%=HeadCOLOR1%>"><font size=<% =fontsize2 %>  COLOR="#FFFFFF"><b>Ranking<br>Score</b></FONT></th> 	
    			</tr>
    			<%
