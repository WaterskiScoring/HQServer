...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td bgcolor="#42639F">
      <p>&nbsp;</p>
      <p align="center"><font face="Verdana" size="6" color="#FFFFFF">USA 
      	Water Ski Registration Details</font></p>
      <p>&nbsp;</p>
    </td>
  </tr>
</table>  
...
<table border="0" cellspacing="0" cellpadding="0">  
  <tr> 
    <td width="150" valign="top" bgcolor="#42639F">
...
Dim RS, sSQL, MemData, OfclRtg, CurrDiv, SlmSco, SlmRtg, TrkSco, TrkRtg, JmpSco, JmpRtg
	...
	<TABLE>
			...
			<TR>
				...
				<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;
					<br>Here is the information for the selected member, to be copied into
					an additional row in your Registration Template spreadsheet.&nbsp;
					Brief instructions appear with the member's information below.&nbsp; 
					<a href="\admin\OneMemberInstructions.htm" target="_blank">Click Here</a>
			...
			<TR> 
				...
				<td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">1.&nbsp;&nbsp; 
					...
					col <b>A</b> cell in the new row.<br>&nbsp;</font></td>
			</TR>
...
IF MemData > "" THEN %>
			...
			<TR> 
				<td>&nbsp;</td>
				<td><font size="1" color="red" face="Verdana, Arial, Helvetica, sans-serif"><br>2.&nbsp;&nbsp; 
...
<% ELSE %>
			...
			<TR> 
				<td>&nbsp;</td>
				<td><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><br>2.&nbsp;&nbsp; 
...
IF RS.EOF THEN 
	...
	IF OfclRtg = "----" THEN %>
			...
			<TR> 
				<td>&nbsp;</td>
				<td><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><br>3.&nbsp;&nbsp; 
...
%>
	...
	<TABLE ALIGN="CENTER" WIDTH=70%><TR><TD>&nbsp;</TD></TR>
		...
		<a href="\admin\OneMemberInstructions.htm" target="_blank">Instructions</a><br>&nbsp;</font>
  	    </td>
