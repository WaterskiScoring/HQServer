...
Dim RExp1, RExp2, RExp3, RPen1, RPen2, RPen3
...
DO UNTIL rs.eof
  ...
  IF left(TempDiv,1) = "C" THEN
  	 RSco1 = RSco1 / 2
     IF nScoC = 2 THEN RPen1 = "with NO Penalty": ELSE RPen1 = "with 50% Penalty"
  ...
  sSQL = sSQL & RExp1 & "With " & RPen1 & "', '  ', '" & R_Ski & "', '" & R_Plc & "', '" & N_Plc & "', " & sProcessingYear & ")"
